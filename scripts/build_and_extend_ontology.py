...
# CONCEPT DOI (not a version DOI): always resolves to the latest Zenodo version.
# A version DOI cannot be embedded here without a circular dependency, since the
# graph is built before it is deposited and the deposit mints the version DOI.
# The manuscript still cites the pinned version DOI; the graph cites the concept.
DATASET_DOI       = "https://identifiers.org/doi:10.5281/zenodo.19427197"
